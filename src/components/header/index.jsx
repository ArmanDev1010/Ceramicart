    ...
    >
      <div className="flex justify-center uppercase text-[12px] font-[400] relative _700:text-[15px]">
        ...
        <motion.div
          variants={opacity}
          animate={!isActive ? "open" : "closed"}
          className="flex gap-[30px] absolute right-0"
        >
          <p className="hidden _700:block _700:cursor-pointer">Shop</p>
      ...
      <motion.div
        ...
        initial="initial"
        animate={isActive ? "open" : "closed"}
        className="bg-black opacity-50 h-full w-full absolute left-0 top-[100%]"
      ></motion.div>
